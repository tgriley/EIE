...
public class PlayerBuffs
{
    ...
    public const float  BaseRegen      = 0.2f;
    public const float  BaseCooldown   = 5f;
    public const double BaseSightRange = 9.0;
    public const double BaseReveal     = 10.0;
    public const float  BaseStun       = 5f;

    public const double RunSpeedPerLevel = 0.5;
    public const float  StaminaPerLevel  = 0.5f;
    public const int    HealthPerLevel   = 25;
    public const float  RegenPerLevel    = 0.25f;
    public const float  CooldownFactor   = 0.85f;
    public const double SightPerLevel    = 1.5;
    public const float  StunPerLevel     = 1f;
    ...
    {
        BuffType.RunSpeed       => "+0.5 sprint speed",
        BuffType.MaxStamina     => "+0.5s max stamina",
        BuffType.MaxHealth      => "+25 max health, keeps hp %",
        BuffType.StaminaRegen   => "+25% stamina regen",
        BuffType.CameraCooldown => "-15% flash cooldown",
        BuffType.SightRange     => "+1.5 tiles sight and minimap",
        _                       => "+1s flash stun"
    };
